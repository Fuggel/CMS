    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div class='huge'><?php echo $posts_count = record_count("posts"); ?></div>
                ...
                $unapproved_comments_count = check_status("comments", "comment_status", "unapproved");
                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ...
                                $element_text = [
                                    "All Posts", "Active Posts", "Draft Posts", "Comments", "Pending Comments",
                                    "Users", "Subscribers", "Categories"
                                ];

                                $element_count = [
                                    $posts_count, $posts_published_count, $posts_draft_count, $comments_count, $unapproved_comments_count,
